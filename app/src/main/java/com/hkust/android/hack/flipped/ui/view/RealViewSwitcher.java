 ...
 */
package com.hkust.android.hack.flipped.ui.view;
 ...
 * <p>
 * You can add and remove views using the normal methods {@link android.view.ViewGroup#addView(android.view.View)}, {@link android.view.ViewGroup#removeView(android.view.View)} etc. You may want to listen for updates by calling {@link RealViewSwitcher#setOnScreenSwitchListener(OnScreenSwitchListener)}
