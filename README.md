...
This repository contains the source code for the [Flipped](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.hkust.android.hack.flipped).

Please see the [issues](https://github.com.hkust.android.hack.flipped/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Flipped? Ask away on the [com-hkust-android-hack-flipped discussion forum](https://groups.google.com/forum/#!forum/com-hkust-android-hack-flipped). 

<a href="https://play.google.com/store/apps/details?id=com.hkust.android.hack.flipped" alt="Download from Google Play">
...
After generating the app on [AndroidBootstrap.com](http://www.androidbootstrap.com) the folder structure of the source code for the app will change:
  ...
  - From: __com.hkust.android.hack.flipped__ 
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.hkust.android.hack.flipped__ will be moved to the new folder __com/notify/app/mobile__. 

All import statments that reference the old resources (__R.com.hkust.android.hack.flipped.R__) will now be renamed to the correct package. The artifact id's in the *pom.xml* (and various other places) will be replaced. The App Name will be replaced in the strings/etc. 
...
signed with a different key.  Manually uninstall Flipped from your device and
...
You can then import the Flipped project by doing File/Import/Gradle/Gradle Project
and the clicking the Browse button to point to the Flipped directory.  Click
...
Flipped is a result of a template project I've developed over the years as well as
...
Flipped is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.hkust.android.hack.flipped/contributors) on this project. Your help is much appreciated.


## Contributing

Please fork this repository and contribute back using
[pull requests](https://github.com.hkust.android.hack.flipped/pulls).
